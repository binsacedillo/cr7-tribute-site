          ...
          {clubs.map((club) => (
            ...
            >
              ...
              <div className="relative z-10">
                <h3 className="mt-5 font-display text-4xl uppercase leading-none md:text-5xl">{club.name}</h3>
