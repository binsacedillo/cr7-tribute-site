        ...
        <div ref={ref} {...props} className={`mt-8 flex snap-x snap-mandatory gap-4 overflow-x-auto pt-6 pb-6 pr-10 -my-6 scrollbar-thin w-full sm:gap-6 md:pr-0 ${props.className}`}>
          {moments.map((moment) => (
            ...
            >
              ...
              <div className="relative z-10 flex min-h-[370px] md:min-h-[380px] flex-col justify-between p-5 md:p-7 w-full h-full">
                <div className="flex items-start justify-between gap-4">
                  <p className="text-sm uppercase tracking-[0.32em] text-museum-gold">{moment.year}</p>
                </div>
                <div>
                  <h3 className="font-display text-4xl uppercase leading-none text-museum-white drop-shadow-[0_2px_20px_rgba(0,0,0,0.5)] md:text-5xl">{moment.title}</h3>
